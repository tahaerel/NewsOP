  ...
  return (
    <>
      <button
        ...
        style={{
          backgroundImage: `url('https://i.hizliresim.com/fuusx73.png')`,
        }}
      ...
      {isOpen && (
        ...
        >
          <span style={{ fontWeight: 600 }}>
            {(() => {
              switch (true) {
                ...
                default:
                  return "📑 Bu toplantıyı yazıya dökün, röportaj metni haline getirin ve özetleyin!";
              }
            })()}
          </span>
          ...
          >
            {!active ? (
              <>
                <span style={{ marginRight: "0.5rem" }}>Bas:</span>
