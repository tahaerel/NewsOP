            ...
            return {
              title: (
                <div className="flex items-center space-x-2">
                  ...
                  <span>API anahtarı ayarlanmamış veya geçersiz!</span>
                </div>
              ) as any,
              description: "NewsOP'u kullanmak için OpenAI API Anahtarını ayarlamanız gerekir.",
              action: (
                <ToastAction
              ...
              title: (
                <div className="flex items-center space-x-2 text-red-600">
                  ...
                  <span>
                    Hata!
                    <br />
                    Mevcut API Anahtarıyla ilgili sorunlar.
                  </span>
                </div>
              ) as any,
  ...
  const handleSubmit = useCallback<FormEventHandler<HTMLFormElement>>(
    async (evt) => {
      ...
      try {
        ...
        onClose();
        toast({
          title: "✅ API başarıyla ayarlandı!",
          description: "NewsOP'un keyfini çıkarın.",
        });
        ...
        if (err instanceof InvalidApiKeyError) {
          msg =
            "Geçersiz API anahtarı. Lütfen API anahtarınızın hala düzgün çalıştığından emin olun.";
        }
      ...
      <form onSubmit={handleSubmit}>
        <DialogHeader>
          <DialogTitle className="flex items-center mb-4">
            ...
            <span> OpenAI API Anahtarınızı Girin</span>
          </DialogTitle>
            ...
            <div>
              ...
              {!errorState && (
                <ul className="list-disc pl-4 text-left space-y-2">
                  <li>NewsOP'u kullanmak için API anahtarı gerekir.</li>
                  <li>
                    API Anahtarınız tarayıcınızda yerel olarak saklanır ve
                    şifrelenir ve asla başka bir yere gönderilmez.
                  </li>
                  <li>
                  NewsOP, yazıya dökmek için Whisper'ı , haber ve röportaj metni için ChatGPT'yi kullanıyor.{" "}
                    <a
                      target="_blank"
                    ...
                    >
                      OpenAI ile ilgili fiyatlandırma
                    </a>
                    .
                  </li>
                </ul>
                ...
                <ul className="list-decimal pl-4">
                  {!errorState && (
                    <li>
                      ...
                      >
                        ...
                        > API anahtarınızı Open AI kontrol panelinden alın.
                        </a>
                      </Button>
                    </li>
                  )}
                  <li>
                    <div className="text-primary">
                      ...
                      Fatura bilgilerinizi eklediğinizden emin olun{" "}
                        <a
                        ...
                        >
                         OpenAI faturalandırma
                        </a>{" "}
                        sayfası.
                      </span>{" "}
                      Fatura bilgileri olmadan API anahtarınız çalışmaz.
                    </div>
                  </li>
                  {errorState && (
                    <li className="text-primary">
                      <span className="font-medium">
                      Yeni Gizli Anahtar oluşturmayı {" "}
                        <a
                          target="_blank"
                          rel="noopener noreferrer"
                          href="https://platform.openai.com/account/api-keys"
                      ...
                      Bazen fatura bilgilerini ekledikten sonra veya diğer durumlarda
              ...
              {errorState && (
                ...
                Aşağıda açıklanan adımları zaten tamamladıysanız bu açılır pencereyi güvenle kapatabilir
                 ve NewsOP'U kullanmaya devam edebilirsiniz.
                </div>
              )}
            </div>
          </DialogDescription>
        ...
        <div className="grid gap-4 py-4">
          ...
          {WEBSITE_URL && (
            <div className="text-xs text-muted-foreground">
              Değişiklikleri Kaydet'i tıklatarak şunları kabul etmiş olursunuz:{" "}
              <a
                className="underline"
        ...
        <Collapsible>
          <div className="mt-4 text-center">
            ...
            <CollapsibleTrigger className="hover:underline" tabIndex={-1}>
              API Key çalışmıyor mu? Buraya tıkla.
            </CollapsibleTrigger>
          </div>
          <CollapsibleContent>
            <ul className="mt-2 list-disc pl-4 text-left space-y-4">
              <li>
                ...
                sayfası. Fatura bilginiz olmadan API çalışmayacaktır.
              </li>
              <li>ChatGPT Plus Aboneliğine gerek yoktur.</li>
            </ul>
          </CollapsibleContent>
        </Collapsible>
      </form>
