  ...
  const statusText = useMemo(
    () =>
      match([recordType, recording, streamActive])
        .with(
          [P.any, P.any, false],
          () => "Metne dönüştürme tamamlandı. Kaydediliyor ve kapatılıyor..."
        )
        .with([P.any, false, P.any], () => "Durduruldu. Devam etmek için tıklayın")
        .with(
          [RecordType.Full, true, P.any],
          () => "Sekme sesini ve mikrofonu kullanarak yazıya dönüştürme..."
        )
        .with(
          [RecordType.StereoOnly, true, P.any],
          () => "Sekme sesini kullanarak yazıya dönüştürme..."
        )
        .otherwise(() => ""),
